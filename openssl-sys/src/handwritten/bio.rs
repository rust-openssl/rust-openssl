...
const_ptr_api! {
    extern "C" {
        pub fn BIO_s_file() -> #[const_ptr_if(ossl110)] BIO_METHOD;
        pub fn BIO_new(type_: #[const_ptr_if(ossl110)] BIO_METHOD) -> *mut BIO;
    }
}
extern "C" {
...
const_ptr_api! {
    extern "C" {
        pub fn BIO_s_mem() -> #[const_ptr_if(ossl110)] BIO_METHOD;
        pub fn BIO_new_mem_buf(buf: #[const_ptr_if(ossl102)] c_void, len: c_int) -> *mut BIO;
    }
}

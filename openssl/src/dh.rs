    ...
    T: HasParams,
{
    ...
    pub fn prime_p(&self) -> BigNum {
        ...
        unsafe {
            ...
            p = ffi::BN_dup(p);
            BigNum::from_ptr(p as *mut _)
        }
    }

    /// Returns the prime `q` from the DH instance.
    pub fn prime_q(&self) -> Option<BigNum> {
        #[cfg(ossl300)]
        return {
        ...
        unsafe {
            ...
            if q.is_null() {
                ...
                q = ffi::BN_dup(q);
                Some(BigNum::from_ptr(q as *mut _))
            }
        }
    }

    /// Returns the generator from the DH instance.
    pub fn generator(&self) -> BigNum {
        #[cfg(ossl300)]
    ...
    T: HasPublic,
{
    ...
    pub fn public_key(&self) -> BigNum {
        ...
        unsafe {
            ...
            pub_key = ffi::BN_dup(pub_key);
            BigNum::from_ptr(pub_key as *mut _)
        }
    }
}
    ...
    T: HasPrivate,
{
    ...
    pub fn compute_key(&self, public_key: &BigNumRef) -> Result<Vec<u8>, ErrorStack> {
        ...
        return {
            ...
            let p = dh_self.prime_p();
            let g = dh_self.generator();
            let mut builder = OsslParamBuilder::new()?;
    ...
    pub fn private_key(&self) -> BigNum {
        ...
        unsafe {
            ...
            priv_key = ffi::BN_dup(priv_key);
            BigNum::from_ptr(priv_key as *mut _)
        }
    }
}
...
mod tests {
    ...
    fn test_dh_stored_restored() {
        ...
        let key2 = dh2.set_private_key(key1.private_key()).unwrap();
    ...
    fn test_set_keys() {
        ...
        let dh2 = Dh::get_2048_256().unwrap();
        let key2 = dh2.set_public_key(key1.public_key()).unwrap();

        assert_eq!(key1.public_key(), key2.public_key());

        let dh3 = Dh::get_2048_256().unwrap();
        let key3 = dh3.set_key(key1.public_key(), key1.private_key()).unwrap();
    ...
    fn test_dh_generate_params_generate_key_compute_key() {
        ...
        let dh_params2 = Dh::from_pqg(dh_params1.prime_p(), None, dh_params1.generator()).unwrap();
    ...
    fn test_roundtrip_dh_key() {
        ...
        let params2 =
            Dh::from_pqg(params1.prime_p(), params1.prime_q(), params1.generator()).unwrap();
        assert_eq!(
